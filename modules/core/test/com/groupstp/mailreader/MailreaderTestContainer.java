package com.groupstp.mailreader;
...
public class MailreaderTestContainer extends TestContainer {

    public MailreaderTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/groupstp/mailreader/app.properties",
    ...
    public static class Common extends MailreaderTestContainer {

        public static final MailreaderTestContainer.Common INSTANCE = new MailreaderTestContainer.Common();
